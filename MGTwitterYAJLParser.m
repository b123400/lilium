...
- (void)_parsingDidEnd
{
	if ([self _isValidDelegateForSelector:@selector(parsingSucceededForRequest:ofResponseType:ofRequestType:withParsedObjects:)]){
		[delegate parsingSucceededForRequest:identifier ofResponseType:responseType ofRequestType:requestType withParsedObjects:parsedObjects];
	}else if ([self _isValidDelegateForSelector:@selector(parsingSucceededForRequest:ofResponseType:withParsedObjects:)]){
