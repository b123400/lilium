...
#define DEFAULT_CLIENT_NAME     @"Maha"
#define DEFAULT_CLIENT_VERSION  @"0.8"
#define DEFAULT_CLIENT_URL      @"http://b123400.net/maha"
#define DEFAULT_CLIENT_TOKEN	@"maha"
                        ...
                        responseType:(MGTwitterResponseType)responseType
{
	...
	NSString *identifier=[self _sendRequest:theRequest withRequestType:requestType responseType:responseType];
	if([(id)_delegate respondsToSelector:@selector(didStartedRequestwithMethod:path:queryParameters:body:requestType:responseType:withIdentifier:)]){
		[((id<BRTwitterEngineDelegate>)_delegate) didStartedRequestwithMethod:method
															  path:path 
												   queryParameters:params
															  body:body 
													   requestType:requestType 
...
- (NSString *)getCurrentTrends
{
    ...
    return [self _sendRequestWithMethod:nil path:path queryParameters:nil body:nil 
                           ...
                           responseType:MGTwitterTrendsResult];
}
